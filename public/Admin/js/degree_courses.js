...
function degree_courses() {
  ...
  <div hidden>
    <div class="col-6" style="flex:1">
      <div class="card card-stats">
        <!-- Card body -->
        <div class="card-body" style="cursor: pointer;" onclick="degree_courses()">
          <div class="row">
            <div class="col text-center">
              <h5 class="card-title text-uppercase text-muted mb-0">Courses</h5>
              <span class="h2 font-weight-bold mb-0" onclick="degree_courses()">Courses</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-6" style="flex:1">
      <div class="card card-stats">
        <!-- Card body -->
        <div class="card-body" style="cursor: pointer;" onclick="degree_courses_Mock_Test()">
          <a>
            <div class="row">
              <div class="col text-center">
                <h5 class="card-title text-uppercase text-muted mb-0">Mock Test</h5>
                <span class="h2 font-weight-bold mb-0" onclick="degree_courses_Mock_Test()">Mock Test</span>
              </div>
            </div>
    ...
    <div class="card card-stats">
      <!-- Card body -->
      <div class="card-body" style="cursor: pointer;" onclick="degree_courses_Study_Materials()">
        <a>
          <div class="row">
            <div class="col text-center">
              <h5 class="card-title text-uppercase text-muted mb-0">Study Materials</h5>
              <span class="h2 font-weight-bold mb-0" onclick="degree_courses_Study_Materials()">Study Materials</span>
            </div>
          </div>
      ...
      <div class="col">
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              <div class="col-lg-6 col-7">
                <h6 class="h2 text-white d-inline-block mb-0">DEGREE COURSES</h6>
              </div>
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_viewdata(null)">Add</a>
              </div>                    
              </div>
          </div>
            ...
            <table class="table align-items-center table-dark table-flush">
              ...
              <tbody class="list" id="maintablecontents">
                <!-- <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="degree_courses_Deletefield(this,null)" >Delete</a></td>
                </tr> -->
                </tbody>
            </table>
          </div>
  ...
  db.collection('Degree_Courses').orderBy('Index').onSnapshot(snapshot => {
    ...
    snapshot.forEach(doc => {
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="degree_courses_viewdata('${doc.id}')"><u>${doc.data().Name}</u></a></th>
                      <td>${doc.data().Index}</td>
                      <td>${doc.data().Active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="degree_courses_Deletefield(this,'${doc.id}')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
    });
...
async function degree_courses_viewdata(docid) {
  if (docid == null) {
    html = `
      <div class="col">
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6 class="h2 text-black d-inline-block mb-0">DEGREE COURSES</h6>
                </div>
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase(null)">Save</a>
                </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" rows="5" placeholder="Details...." id="degree-details"></textarea>
                      </form>
                        </div>
    ...
    let snapshot = await db.collection('Degree_Courses').doc(docid).get();
    html = `
        <div class="col">
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6 class="h2 text-black d-inline-block mb-0">${snapshot.data().Name.toUpperCase()} DEGREE COURSES</h6>
                </div>
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase('${docid}')">Save</a>
                </div>
                </div>
              </div>
            <hr style="margin-bottom: 0;margin-top: 1rem;">
    ...
    document.getElementById('degree-details').value = str;
    ...
    let inner_header = ` <div class="header bg-primary pb-6">
        ...
        <div class="col-6" style="flex:1">
          <div class="card card-stats">
            <!-- Card body -->
            <div class="card-body" style="cursor: pointer;" onclick="degree_courses_preview_page('${snapshot.id}')">
              <div class="row">
                <div class="col text-center">
                  <h5 class="card-title text-uppercase text-muted mb-0">Preview Page</h5>
                  <span class="h2 font-weight-bold mb-0" onclick="degree_courses_preview_page('${snapshot.id}')">Preview Page</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="card card-stats">
      <!-- Card body -->
      <div class="card-body" style="cursor: pointer;" onclick="degree_courses_subject_page('${snapshot.id}')">
        <a>
          <div class="row">
            <div class="col text-center">
              <h5 class="card-title text-uppercase text-muted mb-0">Subjects</h5>
              <span class="h2 font-weight-bold mb-0" onclick="degree_courses_subject_page('${snapshot.id}')">Subjects</span>
            </div>
          </div>
        ...
        <div class="card card-stats">
          <!-- Card body -->
          <div class="card-body" style="cursor: pointer;" onclick="degree_Previous_Year('${snapshot.id}')">
            <a>
              <div class="row">
                <div class="col text-center">
                  <h5 class="card-title text-uppercase text-muted mb-0">Previous Year</h5>
                  <span class="h2 font-weight-bold mb-0" onclick="degree_Previous_Year('${snapshot.id}')">Previous Year</span>
                </div>
              </div>
    ...
    degree_courses_preview_page(`${snapshot.id}`);
  }
}

async function degree_courses_AddToDatabase(docid) {
  ...
  details = $('#degree-details').val().split('\n');
  console.log(Active);
  if (checkempty("Name", Name) || checkempty("Index", Index)) {
    return;
  }

  if (docid == null) {
    await db.collection('Degree_Courses').add({
      Name: document.getElementById("mainsubjectname").value,
    ...
    await db.collection('Degree_Courses').doc(docid).update({
      Name: document.getElementById("mainsubjectname").value,
      Index: Number(document.getElementById("indexofsubject").value),
      Active: document.getElementById("activesubject").checked,
      details: details
...
function degree_courses_Deletefield(input, docid) {
  if (docid != null) {
    if (confirm("Are you sure to delete the main Subject") == false) {
      return
    }
    db.collection('Degree_Courses').doc(docid).delete()
  }
...
function degree_courses_DeleteInnerfield(input, docid, innerDocID, type) {
  if (docid != null && innerDocID != null) {
    if (confirm("Are you sure to delete the main Subject") == false) {
      return
    }
    if (type === 'preview') {
      db.collection('Degree_Courses').doc(docid).collection('Preview').doc(innerDocID).delete();
    } else if (type === 'subject') {
      db.collection('Degree_Courses').doc(docid).collection('Subject').doc(innerDocID).delete();
    }
  }
  else if (confirm("Do you want to Delete the contents of this field") == false) {
    return
...
//preview page
async function degree_courses_preview_page(docid) {
  let table = `<div class="container-fluid mt--6">
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_preview_page_add_view('${docid}',null)">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
  ...
  //loading table data
  await db.collection('Degree_Courses').doc(docid).collection('Preview').orderBy('index').onSnapshot(snapshot => {
    html = ``;
    let index = 1;
    snapshot.forEach((doc) => {
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="degree_courses_preview_page_add_view('${docid}','${doc.id}')"><u>${doc.data().topic}</u></a></th>
                      <td>${doc.data().index}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="degree_courses_DeleteInnerfield(this,'${docid}','${doc.id}','preview')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
      index = index + 1;
...
async function degree_courses_preview_page_add_view(docid, previewid) {
  console.log(docid)
  console.log("preview");
  if (previewid === null) {
          ...
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                ...
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_preview('${docid}',null)">Save</a>
                </div>
                </div>
              </div>
            <hr style="margin-bottom: 0;margin-top: 1rem;">
  ...
  let snapshot = await db.collection('Degree_Courses').doc(docid).collection('Preview').doc(previewid).get();
  html = `
    <div class="col">
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_preview('${docid}','${previewid}')">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
...
async function degree_courses_AddToDatabase_preview(docid, previewid) {
  ...
  for (let index = 0; index < typetopic.length; index++) {
    ...
    if (element == "Note") {
      if (subjectpdf[index].files[0] != undefined) {
        ...
        degree_courses_uploadpdf_wilson(docid, '', true, filelocation, subjectpdf[index].files[0], null, null);
      }
  ...
  if (previewid === null) {
    db.collection('Degree_Courses').doc(docid).collection('Preview').add({
      ...
      degree_courses_uploadpdf(docid, false, filelocation_img, preview_image.files[0], imageprogressno, imageprogressbar, 'preview');
      pdffileno++;
      ...
      degree_courses_uploadpdf(docid, false, filelocation, preview_video.files[0], videoprogressno, videoprogressbar, 'preview');

      db.collection('Degree_Courses').doc(docid).collection('Preview').doc(doc.id).update({
    ...
    db.collection('Degree_Courses').doc(docid).collection('Preview').doc(previewid).update({
      // details: preview_details,
      // price: Number(preview_price),
      ImgUrl: preview_image_url,
      videourl: preview_video_url,
      ...
      if (preview_video.files[0] != undefined || preview_image.files[0] != undefined) {
        ...
        degree_courses_preview_page(docid);
      }
    })
  }
...
//subject page
async function degree_courses_subject_page(docid) {
  let table = `<div class="container-fluid mt--6">
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_subject_page_add_view('${docid}',null)">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
  ...
  //loading table data
  await db.collection('Degree_Courses').doc(docid).collection('Subject').orderBy('index').onSnapshot(snapshot => {
    html = ``;
    let index = 1;
    snapshot.forEach((doc) => {
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="degree_courses_subject_page_add_view('${docid}','${doc.id}')"><u>${doc.data().name}</u></a></th>
                      <td>${doc.data().index}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="degree_courses_DeleteInnerfield(this,'${docid}','${doc.id}','subject')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
      index = index + 1;
...
async function degree_courses_subject_page_add_view(docid, subid) {
  console.log(docid)
  console.log("preview");
  if (subid === null) {
    console.log("sub if");
          ...
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                ...
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_subject('${docid}',null)">Save</a>
                </div>
                </div>
              </div>
            <hr style="margin-bottom: 0;margin-top: 1rem;">
  ...
  let snapshot = await db.collection('Degree_Courses').doc(docid).collection('Subject').doc(subid).get();
  html = `
    <div class="col">
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_subject('${docid}','${subid}')">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
  ...
  document.getElementById('sub-details').value = str;
      ...
      <div class="card bg-default shadow">
        <div class="card-header bg-transparent border-0">
          <div class="row">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_subject_topic_page_add_view('${docid}','${subid}',null)">Add</a>
            </div>                    
            </div>
        </div>
        <div class="table-responsive" style="overflow-y: hidden;">
  ...
  document.getElementById('inner-content').innerHTML = table;
  //loading table data
  db.collection('Degree_Courses').doc(docid).collection('Subject').doc(subid).collection('Topic').orderBy('index').onSnapshot(snapshot => {
    html = ``;
    snapshot.forEach(doc => {
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="degree_courses_subject_topic_page_add_view('${docid}','${subid}','${doc.id}')"><u>${doc.data().TopicName}</u></a></th>
                      <td>${doc.data().index}</td>
                      <td>${doc.data().active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="degree_courses_Delete_inner_inner_field(this,'${docid}','${subid}','${doc.id}')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
    });
...
async function degree_courses_AddToDatabase_subject(docid, subid) {
  ...
  if (subid === null) {
    db.collection('Degree_Courses').doc(docid).collection('Subject').add({
      details: sub_details,
      ...
      // degree_courses_uploadpdf(docid, false, filelocation, sub_video.files[0], videoprogressno, videoprogressbar, 'subject');

      // db.collection('Degree_Courses').doc(docid).collection('Subject').doc(doc.id).update({
      //   videourl: sub_video_url
      // })
      console.log("Uploaded");
      alert("Updation Finished")
      degree_courses_toggle_subject(docid);
    })
  } else {
    ...
    // }
    db.collection('Degree_Courses').doc(docid).collection('Subject').doc(subid).update({
      details: sub_details,
      Price: Number(sub_price),
      // videourl: sub_video_url,
      name: sub_name,
...
async function degree_courses_subject_topic_page_add_view(docid, subid, topicid) {
  if (topicid == null) {
    html = `
    <div class="col">
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right" id='topic-save-update'>
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_topic('${docid}','${subid}',null)">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
    ...
    degree_courses_topic_mock_test(docid, subid, null);
    //ToggleBtw();
  }
  else {
    console.log(`${docid}==${subid}==${topicid}`);
    db.collection("Degree_Courses").doc(docid).collection('Subject').doc(subid).collection('Topic').doc(topicid).get().then(snapshot => {
            ...
            <div class="card">
              ...
              <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-5 text-right" id='topic-save-update'>
                    <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_topic('${docid}','${subid}','${topicid}')">Save</a>
                  </div>
                  </div>
                </div>
              <hr style="margin-bottom: 0;margin-top: 1rem;">
      ...
      degree_courses_topic_mock_test(docid, subid, topicid);
      ...
      add = `
                            <tr>
                              <td >
                                  ...
                                  <td class="text-right">
                                        <span class="btn btn-sm  text-dark" href="#"onclick="degree_courses_Deletefield(this,null)" >Delete</span>
                                  </td>
                          </tr> 
      `
...
async function degree_courses_AddToDatabase_topic(docid, subid, topicid) {
  ...
  if (topicvideo.files[0] != undefined) {
    ...
    degree_courses_uploadpdf_wilson(docid, subid, false, filelocation, topicvideo.files[0], videoprogressno, videoprogressbar);
  }
  ...
  if (topicimage.files[0] != undefined) {
    ...
    degree_courses_uploadpdf_wilson(docid, subid, false, filelocation, topicimage.files[0], imageprogressno, imageprogressbar);
  }
  ...
  for (let index = 0; index < typetopic.length; index++) {
    ...
    if (element == "Note") {
      if (subjectpdf[index].files[0] != undefined) {
        ...
        degree_courses_uploadpdf_wilson(docid, subid, true, filelocation, subjectpdf[index].files[0], null, null);
      }
      else if (subjectpdfurl[index].value == "") {
        alert("Pdf file required")
        return;
  ...
  if (topicid === null) {
    db.collection("Degree_Courses").doc(docid).collection('Subject').doc(subid).collection('Topic').add(topicdata)
      .then(snap => {
        console.log(document.getElementById("topic-save-update").innerHTML)
        document.getElementById("topic-save-update").innerHTML = `<a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_topic('${docid}','${subid}','${snap.id}')">Save</a>`;

        console.log("Fuck");
        degree_courses_topic_mock_test(docid, subid, snap.id);
        if (pdffileno == 0) {
          alert("Updation Finished")
          console.log("reached inside database")
          degree_courses_toggle_topic(docid, subid);
    ...
    db.collection("Degree_Courses").doc(docid).collection('Subject').doc(subid).collection('Topic').doc(topicid).update(topicdata)
      .then(snap => {
        if (pdffileno == 0) {
          alert("Updation Finished")
          console.log("reached inside database")
...
function degree_courses_Delete_inner_inner_field(input, docid, subid, topicid) {
  ...
  if (topicid != null) {
    ...
    db.collection('Degree_Courses').doc(docid).collection('Subject').doc(subid).collection('Topic').doc(topicid).delete();
  }
  else if (confirm("Do you want to Delete the contents of this field") == false) {
    return
  }
...
async function degree_courses_topic_mock_test(docid, subid, topicid) {
  QuestionNo = 0;
  let html = "";
  let add = '';
  if (topicid === null) {
          ...
          <!-- Card Header -->
                      <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
                              <div class="row">
                                      ...
                                      <div class="col-lg-6 col-5 text-right">
                                          <a href="#" class="btn btn-md btn-neutral" id="mock-save-update" onclick="degree_courses_AddMockTest('${docid}','${subid}','${topicid}')" >Save</a>
                                      </div>
                              </div>
                    </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
  ...
  let snap;
  if (topicid !== null) {
    snap = await db.collection('Degree_Courses').doc(docid).collection('Subject').doc(subid).collection('Topic').doc(topicid).get();
...
async function degree_courses_AddMockTest(docid, subid, topicid) {
  if (topicid === "null") {
  ...
  for (let i = 0; i < totalcount; i++) {
    ...
    if (Typearray[i].value == "Paragrah") {
      ...
      if (Imagefile[i].files[0] != undefined) {
        ...
        //degree_courses_uploadpdf(docid,uploadval,Imagefile[i].files[0],progressbar[i],progressno[i]);
    ...
    if (Typearray[i].value == "Question") {
      ...
      if (Imagefile[i].files[0] != undefined) {
        ...
        //await degree_courses_uploadpdf(docid,uploadval,Imagefile[i].files[0],progressbar[i],progressno[i]);
  ...
  db.collection('Degree_Courses').doc(docid).collection('Subject').doc(subid).collection('Topic').doc(topicid).set({
    "Exam": Quiz,
    ...
    .then(snap => {
      ...
      uploadarray.forEach(element => {
        degree_courses_uploadpdf_mocktest(element.docid, element.uploadval, element.Imagefile, element.progressbar, element.progressno, 0)
      });
...
function degree_courses_Study_Materials() {
  console.log("NET PAPERS Entered");
  let html = `
      <div class="header bg-primary pb-6">
          <div class="container-fluid">
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_topic_study_mat_add_view(null)">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
  ...
  document.getElementById('table-list').innerHTML = table;
  //loading table data
  db.collection('Study_Materials').where('type', '==', 'degree_course').orderBy('index').onSnapshot(snapshot => {
    html = ``;
    snapshot.forEach(doc => {
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="degree_courses_topic_study_mat_add_view('${doc.id}')"><u>${doc.data().Name}</u></a></th>
                      <td>${doc.data().index}</td>
                      <td>${doc.data().active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="degree_courses_Deletefield_study_inside(this,'${doc.id}')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
    });
...
function degree_courses_topic_study_mat_add_view(docid) {
  if (docid == null) {
    html = `
    <div class="col">
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_study_material(null)">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
                            ...
                            <table class="table align-items-center">
                              ...
                              <tbody id="tableadd" class="list">
                                <tr>
                                       ...
                                       <!-- <td class="text-right">
                                              <a class="btn btn-sm  text-dark" href="#" onclick="degree_courses_Deletefield_study_inside(this,null)" disabled>Delete</a>
                                        </td> -->
                                </tr>
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_study_material('${docid}')">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
        ...
        snapshot.data().Subjects.forEach(data => {
          ...
          add = `<tr>
                                        ...
                                        <td class="text-right">
                                              <a class="btn btn-sm  text-dark" href="#"onclick="degree_courses_Deletefield_study_inside(this,null)" >Delete</a>
                                        </td>
                                </tr>`
          html = html + add;
        })
...
async function degree_courses_AddToDatabase_study_material(docid) {
  ...
  for (i = 0; i < subjectname.length; i++) {
    ...
    if (subjectpdfurl[index].value == "") {
      if (subjectpdf[index].files[0] == undefined) {
        ...
        pdffileno++;
        console.log("test2")
        await degree_courses_uploadpdf_study_material(mainsubjectname, element.value, subjectpdf[index].files[0], subjectprogressbar[index], subjectprogressno[index]);
...
function degree_courses_Deletefield_study_inside(input, docid) {
  if (docid != null) {
    if (confirm("Are you sure to delete the main Subject") == false) {
      return
    }
...
function degree_courses_Mock_Test() {
  console.log("NET PAPERS Entered");
  let html = `
      <div class="header bg-primary pb-6">
          <div class="container-fluid">
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_mock_sub(null)">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
  ...
  document.getElementById('table-list').innerHTML = table;
  //loading table data
  db.collection('Mock_Test').where('type', '==', 'degree_course').orderBy('index').onSnapshot(snapshot => {
    html = ``;
    snapshot.forEach(doc => {
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="degree_courses_mock_sub('${doc.id}')"><u>${doc.data().name}</u></a></th>
                      <td>${doc.data().index}</td>
                      <td>${doc.data().active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="degree_courses_Delete_mock_org('${doc.id}')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
    });
...
async function degree_courses_mock_sub(docid) {
  if (docid == null) {
    html = `
      <div class="col">
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                ...
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_mock_sub(null)">Save</a>
                </div>
                </div>
              </div>
            <hr style="margin-bottom: 0;margin-top: 1rem;">
              ...
              <div class="row">
                <div class="col">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="select-paper" onchange="degree_select(this,'name')">
                         </select>
                        </div>
      ...
      `
    document.getElementById('editrow').innerHTML = html;
    let ref = await db.collection('Degree_Courses').where('mock_flag', '==', false).orderBy('Index').get()
    ...
    db.collection("Mock_Test").doc(docid).get().then(async doc => {
          ...
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                ...
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="degree_courses_AddToDatabase_mock_sub('${docid}')">Save</a>
                </div>
                </div>
              </div>
            <hr style="margin-bottom: 0;margin-top: 1rem;">
                                ...
                                <table class="table align-items-center">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th scope="col" class="sort"><span class="btn btn-sm btn-dark" onclick="degree_courses_AddNewFeild_mock('${docid}')" >New Field</span></th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                  <tbody id="tableadd" class="list">
      ...
      html = html + add;
      document.getElementById('editrow').innerHTML = html;
      let ref2 = await db.collection('Degree_Courses').where('mock_flag', '==', false).orderBy('Index').get()
      ...
      db.collection("Mock_Test").doc(docid).collection('Tests').orderBy('index').onSnapshot(snapshot => {
        let html2 = '';
        snapshot.forEach((data) => {
          add = `<tr>
                                          <td >
                                           <a href="#" onclick="degree_courses_testview('${docid}','${data.id}')"> <u> ${data.data().name} </u></a>
                                        </td>

                                        <td>
                                              <a class="btn btn-sm  text-dark" href="#"onclick="degree_courses_DeleteMockTest('${docid}','${data.id}')" >Delete</a>
                                        </td>

                                        <td>
                                              <a class="btn btn-sm  text-dark" href="#"onclick="degree_courses_EditField('${docid}','${data.id}','${data.data().name}')" >Edit</a>
                                        </td>
                                </tr>`
          html2 = html2 + add;
          console.log(add)
...
function degree_select(input, type) {
...
async function degree_courses_Delete_mock_org(docid) {
  if (confirm("Do you want Delete mock-test?") == false) {
    return;
  }
  let ref = await db.collection('Mock_Test').doc(docid).get();
  try {
    await db.collection('Degree_Courses').doc(ref.data().Paper_Id).update({
      mock_flag: false
    });
  } catch (error) {
    console.log("Paper already Deleted")
  }
...
function degree_courses_EditField(docid, mockid, mockname) {
...
function degree_courses_DeleteMockTest(docid, mockid) {
...
async function degree_courses_testview(docid, mockid) {
  let snapshot = undefined;
  try {
    snapshot = await db.collection('Mock_Test').doc(docid).collection('Tests').doc(mockid).get();
  } catch (error) {
  ...
  if (snapshot.data().index === undefined) {
    ...
    degree_courses_org_mock_test(docid, mockid);
    //ToggleBtw();
  }
  else {
    console.log(snapshot.data());
...
async function degree_courses_org_mock_test(docid, mockid) {
  QuestionNo = 0;
  let html = "";
  let add = '';
          ...
          <!-- Card Header -->
                      <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
                              <div class="row">
                                      ...
                                      <div class="col-lg-6 col-5 text-right">
                                          <a href="#" class="btn btn-md btn-neutral" id="mock-save-update" onclick="degree_courses_AddMockTest_org('${docid}','${mockid}')" >Save</a>
                                      </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <select class="form-control" id="select-subject">
                                        </select>
                                    </div>
                    </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
  ...
  document.getElementById('topic-mock-test').innerHTML = html;
  let mock = await db.collection('Mock_Test').doc(docid).get();
  let subject = await db.collection('Degree_Courses').doc(mock.data().Paper_Id).collection('Subject').get();
  let options = '<option value="None">None</option>';
  subject.forEach(sub => {
    console.log(sub.data())
    if (sub.id === snap.data().Subject_Id) {
      options += `<option id="${sub.id}" value="${sub.data().name}" selected>${sub.data().name}</option>`;
    } else {
      options += `<option id="${sub.id}" value="${sub.data().name}">${sub.data().name}</option>`;
    }
  });
  document.getElementById('select-subject').innerHTML = options;
  try {
    document.getElementById('mock-active').checked = snap.data().mock_active;
  } catch (error) {
    console.log("mock-active error skipped");
...
async function degree_courses_AddMockTest_org(docid, mockid) {
  imgfileno = 0;
  if (confirm("Do you want to save all the changes?") == false) {
    return;
  }
  ...
  progressbar = document.getElementsByName("progressbar");
  mock_active = document.getElementById('mock-active').checked;
  let sub = document.getElementById('select-subject');
  let sub_id = sub.options[sub.selectedIndex].id;
  ...
  db.collection('Mock_Test').doc(docid).collection('Tests').doc(mockid).set({
    ...
    .then(snap => {
      if (imgfileno == 0) {
        alert("Updation Finished")
        degree_courses_toggle_mock(docid);
      }
      uploadarray.forEach(element => {
        degree_courses_uploadpdf_mocktest(element.docid, element.uploadval, element.Imagefile, element.progressbar, element.progressno, 1)
      });
...
function degree_courses_AddNewFeild_mock(docid) {
...
async function degree_courses_AddToDatabase_mock_sub(docid) {
  ...
  await db.collection('Degree_Courses').doc(mock_paper_id).update({
    mock_flag: true
  });

  if (checkempty("Price", mock_sub_price) || checkempty("Subject Name", mock_sub_name) || checkempty("Subject Index", mock_sub_index)) {
    return;
  }
...
async function degree_courses_mock_test(docid) {
  QuestionNo = 0;
  let html = "";
  let add = '';
  if (docid === null) {
          ...
          <!-- Card Header -->
                      <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
                              <div class="row">
                                      ...
                                      <div class="col-lg-6 col-5 text-right">
                                          <a href="#" class="btn btn-md btn-neutral" id="mock-save-update" onclick="degree_courses_AddMockTest_Net(null)" >Save</a>
                                      </div>
                              </div>
                    </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
          ...
          <!-- Card Header -->
                      <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
                              <div class="row">
                                      ...
                                      <div class="col-lg-6 col-5 text-right">
                                          <a href="#" class="btn btn-md btn-neutral" id="mock-save-update" onclick="degree_courses_AddMockTest_Net('${docid}')" >Save</a>
                                      </div>
                              </div>
                    </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
...
async function degree_courses_AddMockTest_Net(docid, subid, topicid) {
  if (topicid === "null") {
    alert("Save the Topic First");
    return;
  }
...
//previous year
async function degree_Previous_Year(docid) {
  let table = `<div class="container-fluid mt--6">
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="degree_que_paper_add_view('${docid}',null)">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
  ...
  await db.collection('Previous_Year').doc(docid).collection('Question').orderBy('index').onSnapshot(snapshot => {
    ...
    snapshot.forEach((doc) => {
      ...
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="degree_que_paper_add_view('${docid}','${doc.id}')"><u>${doc.data().Subjects[0].Name}</u></a></th>
                      <td>${doc.data().index}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="DeletePrevQue_degree(this,'${docid}','${doc.id}','nill')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
      index = index + 1;
...
function degree_que_paper_add_view(netid, docid) {
  console.log(netid);
  console.log(docid);
  if (docid == null) {
    html = `
        ...
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="AddToDatabase_degree_previous_year('${netid}',null)">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
        ...
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="AddToDatabase_degree_previous_year('${netid}','${docid}')">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
...
async function AddToDatabase_degree_previous_year(netid, docid) {
  ...
  for (i = 0; i < subjectname.length; i++) {
    ...
    if (subjectpdfurl[index].value == "") {
      if (subjectpdf[index].files[0] == undefined) {
        ...
        r.PdfUrl = 'https://firebasestorage.googleapis.com/v0/b/estudo-admin.appspot.com/o/' + 'Previous_Year' + '%2F' + 'degree_course' + '%2F' + element.value + '?alt=media';
        r.Name = subjectname[index].value;
        pdffileno++;
        console.log("test2")
        await degree_courses_uploadpdf_prev_year(netid, element.value, subjectpdf[index].files[0], subjectprogressbar[index], subjectprogressno[index]);
  ...
  db.collection('Previous_Year').doc(netid).collection('Question').doc(docid).set(updatedata)
    .then(snap => {
      if (pdffileno == 0) {
        alert("Updation Finished")
        degree_courses_toggle_prev_year(netid);
        console.log("reached inside database")
      }
    })
    .catch(error => {
...
function DeletePrevQue_degree(input, docid, innerDocID, type) {
  if (docid != null && innerDocID != null) {
...
async function degree_courses_toggle_mock(docid) {
  degree_courses_mock_sub(docid);
}
async function degree_courses_toggle_subject(docid) {
  await degree_courses_viewdata(docid);
  await degree_courses_subject_page(docid);
}

async function degree_courses_toggle_prev_year(docid) {
  await degree_courses_viewdata(docid);
  await degree_Previous_Year(docid);
}

async function degree_courses_toggle_topic(docid, subid) {
  if (confirm("Do you want to go back ? Make sure you saved Mock Test for the topic") == false) {
    return;
  } else {
    await degree_courses_viewdata(docid);
    await degree_courses_subject_page(docid);
    await degree_courses_subject_page_add_view(docid, subid);
  }
...
async function degree_courses_uploadpdf(docid, pdfornot, filelocation, input, subjectprogressno, subjectprogressbar, type) {
  var flag = 0;
  console.log(input)
...
async function degree_courses_uploadpdf_wilson(docid, subid, pdfornot, filelocation, input, subjectprogressno, subjectprogressbar) {
  var flag = 0;
  console.log(input)
...
async function degree_courses_uploadpdf_mocktest(docid, subjectname, input, subjectprogressbar, subjectprogressno, flag) {
  var flag = 0;
  console.log(input)
...
async function degree_courses_uploadpdf_study_material(docid, subjectname, input, subjectprogressbar, subjectprogressno) {
  var flag = 0;
  console.log(input)
...
async function degree_courses_uploadpdf_prev_year(docid, subjectname, input, subjectprogressbar, subjectprogressno) {
  var flag = 0;
  console.log(input)
  ...
  const db = firebase.firestore();
  console.log("subjectname " + subjectname)
  var storageRef_image = firebase.storage().ref('Previous_Year/' + 'degree_course/' + subjectname + '/');
  ...
  uploadTask.on('state_changed', function (snapshot) {
    ...
    if (pdffileno == 0) {
      alert("Updation Finished")
      degree_courses_toggle_prev_year(docid);
      console.log("reached inside storage finsih")
    }
  });
