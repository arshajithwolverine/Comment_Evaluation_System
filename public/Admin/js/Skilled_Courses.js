...
function Skilled_Courses() {
  ...
  <div hidden>
    <div class="col-6" style="flex:1">
      <div class="card card-stats">
        <!-- Card body -->
        <div class="card-body" style="cursor: pointer;" onclick="Skilled_Courses()">
          <div class="row">
            <div class="col text-center">
              <h5 class="card-title text-uppercase text-muted mb-0">Courses</h5>
              <span class="h2 font-weight-bold mb-0" onclick="Skilled_Courses()">Courses</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-6" style="flex:1">
      <div class="card card-stats">
        <!-- Card body -->
        <div class="card-body" style="cursor: pointer;" onclick="skilled_courses_Mock_Test()">
          <a>
            <div class="row">
              <div class="col text-center">
                <h5 class="card-title text-uppercase text-muted mb-0">Mock Test</h5>
                <span class="h2 font-weight-bold mb-0" onclick="skilled_courses_Mock_Test()">Mock Test</span>
              </div>
            </div>
    ...
    <div class="card card-stats">
      <!-- Card body -->
      <div class="card-body" style="cursor: pointer;" onclick="skilled_courses_Study_Materials()">
        <a>
          <div class="row">
            <div class="col text-center">
              <h5 class="card-title text-uppercase text-muted mb-0">Study Materials</h5>
              <span class="h2 font-weight-bold mb-0" onclick="skilled_courses_Study_Materials()">Study Materials</span>
            </div>
          </div>
      ...
      <div class="col">
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              <div class="col-lg-6 col-7">
                <h6 class="h2 text-white d-inline-block mb-0">SKILLED COURSES</h6>
              </div>
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_viewdata(null)">Add</a>
              </div>                    
              </div>
          </div>
            ...
            <table class="table align-items-center table-dark table-flush">
              ...
              <tbody class="list" id="maintablecontents">
                <!-- <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="skilled_courses_Deletefield(this,null)" >Delete</a></td>
                </tr> -->
                </tbody>
            </table>
          </div>
  ...
  db.collection('Skilled_Courses').orderBy('Index').onSnapshot(snapshot => {
    ...
    snapshot.forEach(doc => {
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="skilled_courses_viewdata('${doc.id}')"><u>${doc.data().Name}</u></a></th>
                      <td>${doc.data().Index}</td>
                      <td>${doc.data().Active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="skilled_courses_Deletefield(this,'${doc.id}')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
    });
...
async function skilled_courses_viewdata(docid) {
  if (docid == null) {
    html = `
      <div class="col">
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6 class="h2 text-black d-inline-block mb-0">SKILLED COURSES</h6>
                </div>
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase(null)">Save</a>
                </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="cert_y_n" onchange="certificate(null)">
    ...
    let snapshot = await db.collection('Skilled_Courses').doc(docid).get();
    html = `
        <div class="col">
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6 class="h2 text-black d-inline-block mb-0">${snapshot.data().Name.toUpperCase()} SKILLED COURSE</h6>
                </div>
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase('${docid}')">Save</a>
                </div>
                </div>
              </div>
            <hr style="margin-bottom: 0;margin-top: 1rem;">
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group" style="display:flex">
                        ...
                        <div class="form-group">
                          <label for="example-text-input" class="form-control-label">Have Certificate ?</label>
                          <select class="form-control" id="cert_y_n" onchange="certificate('${docid}')">
                            <option value="No">No</option>
                            <option value="Yes">Yes</option>
                          </select>
                        </div> 
...
async function certificate(docid) {
...
async function skilled_courses_AddToDatabase(docid) {
  ...
  for (i = 0; i < subjectname.length; i++) {
    ...
    if (subjectpdfurl[index].value == "") {
      if (subjectpdf[index].files[0] == undefined) {
        ...
        pdffileno++;
        console.log("test2")
        await skilled_certificate_uploadpdf(docid, element.value, subjectpdf[index].files[0], subjectprogressbar[index], subjectprogressno[index]);
  ...
  if (docid == null) {
    ...
    await db.collection('Skilled_Courses').add(data)
      .then(snap => {
        docid = snap.id;
        console.log(docid);
        if (pdffileno == 0) {
    ...
    await db.collection('Skilled_Courses').doc(docid).update(data)
      .then(() => {
        if (pdffileno == 0) {
          alert("Updation Finished")
          ToggleBack();
...
async function skilled_certificate_uploadpdf(docid, subjectname, input, subjectprogressbar, subjectprogressno) {
  var flag = 0;
  console.log(input)
...
function skilled_courses_Deletefield(input, docid) {
  if (docid != null) {
    if (confirm("Are you sure to delete the main Subject") == false) {
      return
    }
    db.collection('Skilled_Courses').doc(docid).delete()
  }
...
function skilled_courses_DeleteInnerfield(input, docid, innerDocID, type) {
  if (docid != null && innerDocID != null) {
    if (confirm("Are you sure to delete the main Subject") == false) {
      return
    }
    if (type === 'preview') {
      db.collection('Skilled_Courses').doc(docid).collection('Preview').doc(innerDocID).delete();
    } else if (type === 'subject') {
      db.collection('Skilled_Courses').doc(docid).collection('Subject').doc(innerDocID).delete();
    }
  }
  else if (confirm("Do you want to Delete the contents of this field") == false) {
    return
...
//preview page
async function skilled_courses_preview_page(docid) {
  let table = `<div class="container-fluid mt--6">
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_preview_page_add_view('${docid}',null)">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
  ...
  //loading table data
  await db.collection('Skilled_Courses').doc(docid).collection('Preview').orderBy('index').onSnapshot(snapshot => {
    html = ``;
    let index = 1;
    snapshot.forEach((doc) => {
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="skilled_courses_preview_page_add_view('${docid}','${doc.id}')"><u>${doc.data().topic}</u></a></th>
                      <td>${doc.data().index}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="skilled_courses_DeleteInnerfield(this,'${docid}','${doc.id}','preview')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
      index = index + 1;
...
//begining
async function skilled_courses_preview_page_add_view(docid, previewid) {
  console.log(docid)
  console.log("preview");
  if (previewid === null) {
          ...
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                ...
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_preview('${docid}',null)">Save</a>
                </div>
                </div>
              </div>
            <hr style="margin-bottom: 0;margin-top: 1rem;">
  ...
  let snapshot = await db.collection('Skilled_Courses').doc(docid).collection('Preview').doc(previewid).get();
  html = `
    <div class="col">
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_preview('${docid}','${previewid}')">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
...
async function skilled_courses_AddToDatabase_preview(docid, previewid) {
  ...
  for (let index = 0; index < typetopic.length; index++) {
    ...
    if (element == "Note") {
      if (subjectpdf[index].files[0] != undefined) {
        ...
        skilled_courses_uploadpdf_wilson(docid, '', true, filelocation, subjectpdf[index].files[0], null, null);
      }
  ...
  if (previewid === null) {
    db.collection('Skilled_Courses').doc(docid).collection('Preview').add({
      ...
      skilled_courses_uploadpdf(docid, false, filelocation_img, preview_image.files[0], imageprogressno, imageprogressbar, 'preview');
      pdffileno++;
      ...
      skilled_courses_uploadpdf(docid, false, filelocation, preview_video.files[0], videoprogressno, videoprogressbar, 'preview');

      db.collection('Skilled_Courses').doc(docid).collection('Preview').doc(doc.id).update({
    ...
    db.collection('Skilled_Courses').doc(docid).collection('Preview').doc(previewid).update({
      // details: preview_details,
      // price: Number(preview_price),
      ImgUrl: preview_image_url,
      videourl: preview_video_url,
      ...
      if (preview_video.files[0] != undefined || preview_image.files[0] != undefined) {
        ...
        console.log("Updated");
        alert("Updation Finished")
        skilled_courses_preview_page(docid);
      }
    })
  }
...
//subject page
async function skilled_courses_subject_page(docid) {
  let table = `<div class="container-fluid mt--6">
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_subject_topic_page_add_view('${docid}',null)">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
  ...
  //loading table data
  await db.collection('Skilled_Courses').doc(docid).collection('Topic').orderBy('index').onSnapshot(snapshot => {
    html = ``;
    let index = 1;
    snapshot.forEach((doc) => {
      add = `
      <tr>
      <th><a href="#" class="text-white" onclick="skilled_courses_subject_topic_page_add_view('${docid}','${doc.id}')"><u>${doc.data().TopicName}</u></a></th>
      <td>${doc.data().index}</td>
      <td>${doc.data().module}</td>
      <td>${doc.data().active}</td>
      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="skilled_courses_Delete_inner_inner_field(this,'${docid}','${doc.id}')" >Delete</a></td>
    </tr>
          `;
      html = html + add;
      index = index + 1;
...
async function skilled_courses_subject_page_add_view(docid, subid) {
  console.log(docid)
  console.log("preview");
  if (subid === null) {
    console.log("sub if");
          ...
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                ...
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_subject('${docid}',null)">Save</a>
                </div>
                </div>
              </div>
            <hr style="margin-bottom: 0;margin-top: 1rem;">
  ...
  let snapshot = await db.collection('Skilled_Courses').doc(docid).collection('Subject').doc(subid).get();
  html = `
    <div class="col">
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_subject('${docid}','${subid}')">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
      ...
      <div class="card bg-default shadow">
        <div class="card-header bg-transparent border-0">
          <div class="row">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_subject_topic_page_add_view('${docid}','${subid}',null)">Add</a>
            </div>                    
            </div>
        </div>
        <div class="table-responsive" style="overflow-y: hidden;">
  ...
  document.getElementById('inner-content').innerHTML = table;
  //loading table data
  db.collection('Skilled_Courses').doc(docid).collection('Subject').doc(subid).collection('Topic').orderBy('index').onSnapshot(snapshot => {
    html = ``;
    snapshot.forEach(doc => {
      add = `
                    <tr>
...
async function skilled_courses_AddToDatabase_subject(docid, subid) {
  ...
  if (subid === null) {
    db.collection('Skilled_Courses').doc(docid).collection('Subject').add({
      details: sub_details,
      ...
      // skilled_courses_uploadpdf(docid, false, filelocation, sub_video.files[0], videoprogressno, videoprogressbar, 'subject');

      // db.collection('Skilled_Courses').doc(docid).collection('Subject').doc(doc.id).update({
      //   videourl: sub_video_url
      // })
      console.log("Uploaded");
      alert("Updation Finished")
      skilled_courses_toggle_subject(docid);
    })
  } else {
    ...
    // }
    db.collection('Skilled_Courses').doc(docid).collection('Subject').doc(subid).update({
      details: sub_details,
      price: Number(sub_price),
      // videourl: sub_video_url,
      name: sub_name,
...
async function skilled_courses_subject_topic_page_add_view(docid, topicid) {
  if (topicid == null) {
    html = `
    <div class="col">
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right" id='topic-save-update'>
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_topic('${docid}',null)">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
            ...
            <div class="row">
              ...
              <div class="form-group" style="display:flex">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          <label for="example-text-input" class="form-control-label">Module Number</label>
                          <input class="form-control" type="number" value="" id="topic-module">
                      </div>
                      <div class="form-group">
                          <label for="example-text-input" class="form-control-label">Module Name</label>
                          <input class="form-control" type="text" value="" id="module-name">
                      </div>


                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label">Module Image</label>
                        <div class="media-body">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" onchange="loadFile_module(event)" lang="en" style="width: auto;" accept="image" id="topicimage-module">
                            <input type="text" id="ImgUrl-module" value="" hidden>
                          </div>
                          <div class="progress-info">
                              <div class="progress-label">
                                <span name="imageprogressno-module">0%</span>
                              </div>
                          </div>
                          <div class="progress" >
                              <div class="progress-bar bg-success" role="progressbar"  style="width: 0%;" id="imageprogressbar-module"></div>
                          </div>
                          <img id="outputstorage-module" style="height: 230px;width: 400px;">
                        </div>
                      </div>
                      ...
                      <div class="table-responsive" style="overflow-y: hidden;">
                        ...
                        <div>
                        <label for="example-text-input" class="form-control-label">Downloadable Activity</label>
                            <table class="table align-items-center">
                                <thead class="thead-light">
                                    <tr>
                                        <th scope="col" class="sort" data-sort="name">Note Name</th>
                                        <th scope="col" class="sort" data-sort="budget">Note File</th>
                                        <th scope="col" class="text-right"><span class="btn btn-sm btn-dark" onclick="AddNewUnitOrNote_copy(this,null,'Note')" >New Note</span></th>
                                    </tr>
                                </thead>
                              <tbody id="tableadd_copy" class="list">
    ...
    skilled_courses_topic_mock_test(docid, null);
    //ToggleBtw();
  }
  else {
    db.collection("Skilled_Courses").doc(docid).collection('Topic').doc(topicid).get().then(snapshot => {
            ...
            <div class="card">
              ...
              <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-5 text-right" id='topic-save-update'>
                    <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_topic('${docid}','${topicid}')">Save</a>
                  </div>
                  </div>
                </div>
              <hr style="margin-bottom: 0;margin-top: 1rem;">
                ...
                <div class="row">
                  ...
                  <div class="form-group" style="display:flex">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          <label for="example-text-input" class="form-control-label">Module Number</label>
                          <input class="form-control" type="number" value="${snapshot.data().module}" id="topic-module">
                      </div>
                      <div class="form-group">
                          <label for="example-text-input" class="form-control-label">Module Name</label>
                          <input class="form-control" type="text" value="${snapshot.data().module_name}" id="module-name">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="media-body">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" onchange="loadFile_module(event)" lang="en" style="width: auto;" accept="image" id="topicimage-module">
                            <input type="text" id="ImgUrl-module" value="${snapshot.data().ModuleUrl}" hidden>
                          </div>
                          <div class="progress-info">
                              <div class="progress-label">
                                <span name="imageprogressno-module">0%</span>
      ...
      skilled_courses_topic_mock_test(docid, topicid);
      ...
      snapshot.data().Downloadable_Activity.forEach(element => {

        AddNewUnitOrNote_copy(null, element, element.type);
      ...
      storageRef.refFromURL(snapshot.data().ModuleUrl).getDownloadURL().then(function (url) {

        // Or inserted into an <img> element:
        var img = document.getElementById('outputstorage-module');
        img.src = url;
      }).catch(function (error) {
        // Handle any errors
      });
      ...
      add = `
                            <tr>
                              <td >
                                  ...
                                  <td class="text-right">
                                        <span class="btn btn-sm  text-dark" href="#"onclick="skilled_courses_Deletefield(this,null)" >Delete</span>
                                  </td>
                          </tr> 
      `
...
function AddNewUnitOrNote_copy(input, data, type) {
      ...
      add = `
                            <tr>
                              <td >
                                      <div class="media align-items-center">
                                          <div class="media-body">
                                            <input class="form-control" type="text" value="Note"  name="type_copy" hidden>
                                            <input class="form-control" type="text" value=""  name="UnitName_copy">
                                          </div>
                                      </div>
                                  </td>
                                  
                                  <td>
                                            <input type="file" name="subjectpdf_copy">
                                            <input type="text" name="PdfUrl_copy" value="" hidden>
                                            <input type="text" name="Extension" value="" hidden> 
        ...
        <tr>
          <td >
                                        ...
                                        <td>
                                          ...
                                          <input type="file" name="subjectpdf" hidden>
                                          <input type="text" name="PdfUrl" value="" hidden> 
                                        </td>
                                        <td class="text-right">
                                              <span class="btn btn-sm  text-dark" href="#"onclick="skilled_courses_Deletefield(this,null)" >Delete</span>
                           ...
                           <tr>
                                    <td >
                                      <div class="media align-items-center">
                                          <div class="media-body">
                                            <input class="form-control" type="text" value="Note"  name="type_copy" hidden>
                                            <input class="form-control" type="text" value="${data.UnitName}"  name="UnitName_copy">
                                          </div>
                                      </div>
                                  </td>
                                  ...
                                  <td>
                                            <a href="${data.PdfUrl + dummycalc()}" target="_blank" style="cursor: pointer;">View PDF</a>
                                            <input type="file" name="subjectpdf_copy">
                                            <input type="text" name="PdfUrl_copy" value="${data.PdfUrl}" hidden>
                                            <input type="text" name="Extension" value="${data.Extension}" hidden>  
                                            <input  type="time" step="2" min="23:00" max="01:00" name="UnitTime" value="00:00:00" hidden>                                                                                           
                                  </td>
  ...
  var element = document.getElementById('tableadd_copy'); //input.parentNode.parentNode.parentNode.nextSibling.nextSibling;
  //element.appendChild(element);
  console.log(element)
...
async function skilled_courses_AddToDatabase_topic(docid, topicid) {
  ...
  Units_copy = []
  typetopic_copy = document.getElementsByName('type_copy');
  UnitName_copy = document.getElementsByName('UnitName_copy');
  UnitTime_copy = document.getElementsByName('UnitTime_copy');
  subjectpdf_copy = document.getElementsByName('subjectpdf_copy');
  subjectpdfurl_copy = document.getElementsByName('PdfUrl_copy');


  topicvideo = document.getElementById('topicvideo');

  topicimage = document.getElementById('topicimage');
  topicimage_module = document.getElementById('topicimage-module');

  imageprogressbar = document.getElementById('imageprogressbar');
  imageprogressbar_module = document.getElementById('imageprogressbar-module');

  videoprogressbar = document.getElementById('videoprogressbar');

  subjectimageurl = document.getElementById('ImgUrl');
  subjectimageurl_module = document.getElementById('ImgUrl-module');

  subjectvideourl = document.getElementById('VideoUrl');

  imageprogressno = document.getElementsByName('imageprogressno');
  imageprogressno_module = document.getElementsByName('imageprogressno-module');

  videoprogressno = document.getElementsByName('videoprogressno');

  topic_index = document.getElementById('topic-index').value;
  topic_module = document.getElementById('topic-module').value;
  ...
  if (topicvideo.files[0] != undefined) {
    ...
    skilled_courses_uploadpdf_wilson(docid, false, filelocation, topicvideo.files[0], videoprogressno, videoprogressbar);
  }
  ...
  if (topicimage.files[0] != undefined) {
    ...
    skilled_courses_uploadpdf_wilson(docid, false, filelocation, topicimage.files[0], imageprogressno, imageprogressbar);
  }
  ...
  let ImgUrl_module = '';
  if (topicimage_module.files[0] != undefined) {
    ImgUrl_module = `https://firebasestorage.googleapis.com/v0/b/estudo-admin.appspot.com/o/Images%2F${docid}%2FTopicModule%2FImage${n}?alt=media`;
    pdffileno++;
    filelocation_module = `Images/${docid}/TopicModule/Image${n}`;
    skilled_courses_uploadpdf_wilson(docid, false, filelocation_module, topicimage_module.files[0], imageprogressno_module, imageprogressbar_module);
  }
  else if (subjectimageurl.value == "") {
    console.log("No module image")
  }
  else {
    ImgUrl_module = subjectimageurl_module.value;
  }
  ...
  for (let index_copy = 0; index_copy < typetopic_copy.length; index_copy++) {
    const element = typetopic_copy[index_copy].value;
    r = {};
    r.type = element
    r.UnitName = UnitName_copy[index_copy].value;

    if (element == "Note") {
      if (subjectpdf_copy[index_copy].files[0] != undefined) {
        r.PdfUrl = `https://firebasestorage.googleapis.com/v0/b/estudo-admin.appspot.com/o/DownloadableNotes%2F${docid}%2FTopic%2FUnitNote${n}?alt=media`;
        r.Extension = subjectpdf_copy[index_copy].value.split('.').pop();
        pdffileno++;
        filelocation = `DownloadableNotes/${docid}/Topic/UnitNote${n}`
        skilled_courses_uploadpdf_wilson(docid, true, filelocation, subjectpdf_copy[index_copy].files[0], null, null);
      }
      else if (subjectpdfurl_copy[index_copy].value == "") {
        alert("Pdf file required")
        return;
      }
      else {
        r.PdfUrl = subjectpdfurl_copy[index_copy].value;
        r.Extension = document.getElementsByName('Extension')[index_copy].value;
      }
    }
    else {
      r.UnitTime = timeformat(UnitTime_copy[index_copy].value);
    }
    Units_copy.push(r);
  ...
  topicdata = {
    ...
    VideoUrl: VideoUrl,
    module: Number(topic_module),
    module_name: module_name,
    ModuleUrl: ImgUrl_module,
    ImgUrl: ImgUrl,
    Units: Units,
    Downloadable_Activity: Units_copy,
    index: Number(topic_index),
    active: topic_active

  }
  if (topicid === null) {
    db.collection("Skilled_Courses").doc(docid).collection('Topic').add(topicdata)
      .then(snap => {
        console.log(document.getElementById("topic-save-update").innerHTML)
        document.getElementById("topic-save-update").innerHTML = `<a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_topic('${docid}','${snap.id}')">Save</a>`;

        console.log("Fuck");
        skilled_courses_topic_mock_test(docid, snap.id);
        if (pdffileno == 0) {
          alert("Updation Finished")
          console.log("reached inside database")
          skilled_courses_toggle_topic(docid);
    ...
    db.collection("Skilled_Courses").doc(docid).collection('Topic').doc(topicid).update(topicdata)
      .then(snap => {
        if (pdffileno == 0) {
          alert("Updation Finished")
          console.log("reached inside database")
...
function skilled_courses_Delete_inner_inner_field(input, docid, topicid) {
  ...
  if (topicid != null) {
    ...
    db.collection('Skilled_Courses').doc(docid).collection('Topic').doc(topicid).delete();
  }
  else if (confirm("Do you want to Delete the contents of this field") == false) {
    return
  }
...
async function skilled_courses_topic_mock_test(docid, topicid) {
  QuestionNo = 0;
  let html = "";
  let add = '';
  if (topicid === null) {
          ...
          <!-- Card Header -->
                      <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
                              <div class="row">
                                      ...
                                      <div class="col-lg-6 col-5 text-right">
                                          <a href="#" class="btn btn-md btn-neutral" id="mock-save-update" onclick="skilled_courses_AddMockTest('${docid}','${topicid}')" >Save</a>
                                      </div>
                              </div>
                    </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
  ...
  let snap;
  if (topicid !== null) {
    snap = await db.collection('Skilled_Courses').doc(docid).collection('Topic').doc(topicid).get();
...
async function skilled_courses_AddMockTest(docid, topicid) {
  if (topicid === "null") {
  ...
  for (let i = 0; i < totalcount; i++) {
    ...
    if (Typearray[i].value == "Paragrah") {
      ...
      if (Imagefile[i].files[0] != undefined) {
        ...
        //skilled_courses_uploadpdf(docid,uploadval,Imagefile[i].files[0],progressbar[i],progressno[i]);
    ...
    if (Typearray[i].value == "Question") {
      ...
      if (Imagefile[i].files[0] != undefined) {
        ...
        //await skilled_courses_uploadpdf(docid,uploadval,Imagefile[i].files[0],progressbar[i],progressno[i]);
  ...
  db.collection('Skilled_Courses').doc(docid).collection('Topic').doc(topicid).set({
    "Exam": Quiz,
    ...
    .then(snap => {
      ...
      uploadarray.forEach(element => {
        skilled_courses_uploadpdf_mocktest(element.docid, element.uploadval, element.Imagefile, element.progressbar, element.progressno, 0)
      });
...
function skilled_courses_Study_Materials() {
  console.log("NET PAPERS Entered");
  let html = `
      <div class="header bg-primary pb-6">
          <div class="container-fluid">
        ...
        <div class="card-body" style="cursor: pointer;" onclick="Skilled_Courses()">
          <div class="row">
            <div class="col text-center">
              ...
              <span class="h2 font-weight-bold mb-0" onclick="Skilled_Courses()">Course</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_topic_study_mat_add_view(null)">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
  ...
  document.getElementById('table-list').innerHTML = table;
  //loading table data
  db.collection('Study_Materials').where('type', '==', 'Skilled_Courses').orderBy('index').onSnapshot(snapshot => {
    html = ``;
    snapshot.forEach(doc => {
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="skilled_courses_topic_study_mat_add_view('${doc.id}')"><u>${doc.data().Name}</u></a></th>
                      <td>${doc.data().index}</td>
                      <td>${doc.data().active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="skilled_courses_Deletefield_study_inside(this,'${doc.id}')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
    });
...
function skilled_courses_topic_study_mat_add_view(docid) {
  if (docid == null) {
    html = `
    <div class="col">
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_study_material(null)">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
                            ...
                            <table class="table align-items-center">
                              ...
                              <tbody id="tableadd" class="list">
                                <tr>
                                       ...
                                       <!-- <td class="text-right">
                                              <a class="btn btn-sm  text-dark" href="#" onclick="skilled_courses_Deletefield_study_inside(this,null)" disabled>Delete</a>
                                        </td> -->
                                </tr>
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_study_material('${docid}')">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
        ...
        snapshot.data().Subjects.forEach(data => {
          ...
          add = `<tr>
                                        ...
                                        <td class="text-right">
                                              <a class="btn btn-sm  text-dark" href="#"onclick="skilled_courses_Deletefield_study_inside(this,null)" >Delete</a>
                                        </td>
                                </tr>`
          html = html + add;
        })
...
async function skilled_courses_AddToDatabase_study_material(docid) {
  ...
  for (i = 0; i < subjectname.length; i++) {
    ...
    if (subjectpdfurl[index].value == "") {
      if (subjectpdf[index].files[0] == undefined) {
        ...
        pdffileno++;
        console.log("test2")
        await skilled_courses_uploadpdf_study_material(mainsubjectname, element.value, subjectpdf[index].files[0], subjectprogressbar[index], subjectprogressno[index]);
...
function skilled_courses_Deletefield_study_inside(input, docid) {
  if (docid != null) {
    if (confirm("Are you sure to delete the main Subject") == false) {
      return
    }
...
function skilled_courses_Mock_Test() {
  console.log("NET PAPERS Entered");
  let html = `
      <div class="header bg-primary pb-6">
          <div class="container-fluid">
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_mock_sub(null)">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
  ...
  document.getElementById('table-list').innerHTML = table;
  //loading table data
  db.collection('Mock_Test').where('type', '==', 'Skilled_Courses').orderBy('index').onSnapshot(snapshot => {
    html = ``;
    snapshot.forEach(doc => {
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="skilled_courses_mock_sub('${doc.id}')"><u>${doc.data().name}</u></a></th>
                      <td>${doc.data().index}</td>
                      <td>${doc.data().active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="skilled_courses_Delete_mock_org('${doc.id}')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
    });
...
async function skilled_courses_mock_sub(docid) {
  if (docid == null) {
    html = `
      <div class="col">
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                ...
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_mock_sub(null)">Save</a>
                </div>
                </div>
              </div>
            <hr style="margin-bottom: 0;margin-top: 1rem;">
              ...
              <div class="row">
                <div class="col">
                        ...
                        <div class="form-group">
                          ...
                          <select id="select-paper" onchange="skilled_paper_select(this,'name')">
                         </select>
                        </div>
      ...
      `
    document.getElementById('editrow').innerHTML = html;
    let ref = await db.collection('Skilled_Courses').where('mock_flag', '==', false).orderBy('Index').get()
    ...
    db.collection("Mock_Test").doc(docid).get().then(async doc => {
          ...
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                ...
                <div class="col-lg-6 col-5 text-right">
                  <a href="#" class="btn btn-md btn-neutral" onclick="skilled_courses_AddToDatabase_mock_sub('${docid}')">Save</a>
                </div>
                </div>
              </div>
            <hr style="margin-bottom: 0;margin-top: 1rem;">
      ...
      html = html + add;
      document.getElementById('editrow').innerHTML = html;
      let ref2 = await db.collection('Skilled_Courses').where('mock_flag', '==', false).orderBy('Index').get()
      ...
      db.collection("Mock_Test").doc(docid).collection('Tests').onSnapshot(snapshot => {
        ...
        snapshot.forEach((data) => {
          add = `<tr>
                                          <td >
                                           <a href="#" onclick="skilled_courses_testview('${docid}','${data.id}')"> <u> ${data.data().name} </u></a>
                                        </td>

                                        <td>
                                              <a class="btn btn-sm  text-dark" href="#"onclick="skilled_courses_DeleteMockTest('${docid}','${data.id}')" >Delete</a>
                                        </td>

                                        <td>
                                              <a class="btn btn-sm  text-dark" href="#"onclick="skilled_courses_EditField('${docid}','${data.id}','${data.data().name}')" >Edit</a>
                                        </td>
                                </tr>`
          html2 = html2 + add;
          console.log(add)
...
function skilled_paper_select(input, type) {
...
async function skilled_courses_Delete_mock_org(docid) {
  if (confirm("Do you want edit mock-test?") == false) {
    return;
  }
  let ref = await db.collection('Mock_Test').doc(docid).get();
  await db.collection('Skilled_Courses').doc(ref.data().Paper_Id).update({
    mock_flag: false
  });
...
function skilled_courses_EditField(docid, mockid, mockname) {
...
function skilled_courses_DeleteMockTest(docid, mockid) {
...
async function skilled_courses_testview(docid, mockid) {
  ...
  if (snapshot.data().index === undefined) {
    ...
    skilled_courses_org_mock_test(docid, mockid, null);
    //ToggleBtw();
  }
  else {
    console.log(snapshot.data());
    html = `
        ...
        `
    document.getElementById('editrow').innerHTML = html;
    skilled_courses_org_mock_test(docid, mockid);
    var storageRef = firebase.storage();
    storageRef.refFromURL(snapshot.data().ImgUrl).getDownloadURL().then(function (url) {
...
async function skilled_courses_org_mock_test(docid, mockid) {
  QuestionNo = 0;
  let html = "";
  let add = '';
          ...
          <!-- Card Header -->
                      <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
                              <div class="row">
                                      ...
                                      <div class="col-lg-6 col-5 text-right">
                                          <a href="#" class="btn btn-md btn-neutral" id="mock-save-update" onclick="skilled_courses_AddMockTest_org('${docid}','${mockid}')" >Save</a>
                                      </div>
...
async function skilled_courses_AddMockTest_org(docid, mockid) {
  imgfileno = 0;
  if (confirm("Do you want to save all the changes?") == false) {
    return;
  }
  ...
  db.collection('Mock_Test').doc(docid).collection('Tests').doc(mockid).set({
    ...
    .then(snap => {
      if (imgfileno == 0) {
        alert("Updation Finished")
        skilled_courses_toggle_mock(docid);
      }
      uploadarray.forEach(element => {
        skilled_courses_uploadpdf_mocktest(element.docid, element.uploadval, element.Imagefile, element.progressbar, element.progressno, 1)
      });
...
async function skilled_courses_AddToDatabase_mock_sub(docid) {
  ...
  await db.collection('Skilled_Courses').doc(mock_paper_id).update({
    mock_flag: true
  });
...
async function skilled_courses_mock_test(docid) {
  QuestionNo = 0;
  let html = "";
  let add = '';
  if (docid === null) {
          ...
          <!-- Card Header -->
                      <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
                              <div class="row">
                                      ...
                                      <div class="col-lg-6 col-5 text-right">
                                          <a href="#" class="btn btn-md btn-neutral" id="mock-save-update" onclick="skilled_courses_AddMockTest_Net(null)" >Save</a>
                                      </div>
                              </div>
                    </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
          ...
          <!-- Card Header -->
                      <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
                              <div class="row">
                                      ...
                                      <div class="col-lg-6 col-5 text-right">
                                          <a href="#" class="btn btn-md btn-neutral" id="mock-save-update" onclick="skilled_courses_AddMockTest_Net('${docid}')" >Save</a>
                                      </div>
                              </div>
                    </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
...
async function skilled_courses_AddMockTest_Net(docid, subid, topicid) {
  if (topicid === "null") {
    alert("Save the Topic First");
    return;
  }
  ...
  console.log("ultitest");
  db.collection('Skilled_Courses').doc(docid).collection('Subject').doc(subid).collection('Topic').doc(topicid).set({
    "Exam": Quiz,
    "mock_active": mock_active
  }, { merge: true })
    .then(snap => {
...
//previous year
async function Skilled_Previous_Year(docid) {
  let table = `<div class="container-fluid mt--6">
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skill_que_paper_add_view('${docid}',null)">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
  ...
  await db.collection('Previous_Year').doc(docid).collection('Question').orderBy('index').onSnapshot(snapshot => {
    ...
    snapshot.forEach((doc) => {
      ...
      add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="skill_que_paper_add_view('${docid}','${doc.id}')"><u>${doc.data().Subjects[0].Name}</u></a></th>
                      <td>${doc.data().index}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="skilled_DeletePrevQue(this,'${docid}','${doc.id}','nill')" >Delete</a></td>
                    </tr>
          `;
      html = html + add;
      index = index + 1;
...
function skill_que_paper_add_view(netid, docid) {
  console.log(netid);
  console.log(docid);
  if (docid == null) {
    html = `
        ...
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_AddToDatabase_previous_year('${netid}',null)">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
        ...
        <div class="card">
          ...
          <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="skilled_AddToDatabase_previous_year('${netid}','${docid}')">Save</a>
              </div>
              </div>
            </div>
          <hr style="margin-bottom: 0;margin-top: 1rem;">
...
async function skilled_AddToDatabase_previous_year(netid, docid) {
  ...
  for (i = 0; i < subjectname.length; i++) {
    ...
    if (subjectpdfurl[index].value == "") {
      if (subjectpdf[index].files[0] == undefined) {
        ...
        r.PdfUrl = 'https://firebasestorage.googleapis.com/v0/b/estudo-admin.appspot.com/o/' + 'Previous_Year' + '%2F' + 'skilled_course' + '%2F' + element.value + '?alt=media';
        r.Name = subjectname[index].value;
        pdffileno++;
        console.log("test2")
        await skilled_courses_uploadpdf_prev_year(netid, element.value, subjectpdf[index].files[0], subjectprogressbar[index], subjectprogressno[index]);
  ...
  db.collection('Previous_Year').doc(netid).collection('Question').doc(docid).set(updatedata)
    .then(snap => {
      if (pdffileno == 0) {
        alert("Updation Finished")
        skilled_courses_toggle_prev_year(netid);
        console.log("reached inside database")
      }
    })
    .catch(error => {
...
function skilled_DeletePrevQue(input, docid, innerDocID, type) {
  if (docid != null && innerDocID != null) {
...
async function skilled_courses_toggle_mock(docid) {
  skilled_courses_mock_sub(docid);
}
async function skilled_courses_toggle_subject(docid) {
  await skilled_courses_viewdata(docid);
  await skilled_courses_subject_page(docid);
}

async function skilled_courses_toggle_prev_year(docid) {
  await skilled_courses_viewdata(docid);
  await Skilled_Previous_Year(docid);
}

async function skilled_courses_toggle_topic(docid) {
  if (confirm("Do you want to go back ? Make sure you saved Mock Test for the topic") == false) {
    return;
  } else {
    await skilled_courses_viewdata(docid);
    await skilled_courses_subject_page(docid);
    // await skilled_courses_subject_page_add_view(docid, subid);
  }
...
var loadFile_module = function (event) {

  var output = document.getElementById('outputstorage-module');
  output.src = URL.createObjectURL(event.target.files[0]);
};
...
async function skilled_courses_uploadpdf(docid, pdfornot, filelocation, input, subjectprogressno, subjectprogressbar, type) {
  var flag = 0;
  console.log(input)
...
async function skilled_courses_uploadpdf_wilson(docid, pdfornot, filelocation, input, subjectprogressno, subjectprogressbar) {
  var flag = 0;
  console.log(input)
...
async function skilled_courses_uploadpdf_mocktest(docid, subjectname, input, subjectprogressbar, subjectprogressno, flag) {
  var flag = 0;
  console.log(input)
...
async function skilled_courses_uploadpdf_study_material(docid, subjectname, input, subjectprogressbar, subjectprogressno) {
  var flag = 0;
  console.log(input)
...
async function skilled_courses_uploadpdf_prev_year(docid, subjectname, input, subjectprogressbar, subjectprogressno) {
  var flag = 0;
  console.log(input)
  ...
  const db = firebase.firestore();
  console.log("subjectname " + subjectname)
  var storageRef_image = firebase.storage().ref('Previous_Year/' + 'skilled_course/' + subjectname + '/');
  ...
  uploadTask.on('state_changed', function (snapshot) {
    ...
    if (pdffileno == 0) {
      alert("Updation Finished")
      skilled_courses_toggle_prev_year(docid);
      console.log("reached inside storage finsih")
    }
  });
